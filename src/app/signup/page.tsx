...
const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path d="M24 12c0-1.84-.16-3.6-.45-5.28H12.48v3.28h7.84c-.24 1.54-.88 2.86-1.94 3.68a6.5 6.5 0 0 1 -4.48 1.32c-3.58 0-6.48-2.9-6.48-6.48s2.9-6.48 6.48-6.48c1.98 0 3.54.82 4.64 1.84l2.56-2.56C18.08 1.08 15.24 0 12 0S4.95 1.08 2.87 2.84l2.64 2.56C6.15 4.04 7.4 3.52 9.52 3.52c3.58 0 6.48 2.9 6.48 6.48s-2.9 6.48-6.48 6.48c-2.12 0-3.37-.52-4.02-1.24l-2.64 2.56C5.45 20.92 8.29 22 11.04 22l.96-.02z" fill="#EA4335" />
...
export default function SignupPage() {
  ...
  const handleEmailSignUp = (e: React.FormEvent) => {
    ...
    console.log('Signing up with:', { name, email, password, olYear, province: selectedProvince, district: selectedDistrict });
